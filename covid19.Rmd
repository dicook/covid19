---
title: "Examining COVID-19 data, w/ web browser, not mobile"
output: 
...
*Latest incidence and testing rates, per 100k people*
...
ggplot(china_count, aes(x=count, y=daily)) + geom_point()
```
